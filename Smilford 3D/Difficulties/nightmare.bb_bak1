AppTitle "Smilford 3D! NIGHTMARE By KABX - Beta"
; (c) 2022 KerbalABX
...
brick=LoadTexture("media\tex\fire.bmp")
...
;enemy
;enemy=CreateCube()
;PositionEntity enemy,-5,0,6
;RotateEntity enemy,Rnd(360),Rnd(360),Rnd(360)
;EntityType enemy,ENEMY_COL
;enemytex=LoadTexture("media\tex\pyrad.bmp")
;EntityTexture enemy,enemytex
...
texture=LoadTexture("media\tex\sphere.bmp")
...
;Collisions SPHERE_COL,ENEMY_COL,3,1
...
While Not KeyDown(1)
	...
	If MilliSecs() >= oldTime Then
		PositionEntity cube,pux,0,puz
		;PointEntity enemy,cube
		;TranslateEntity enemy,EntityX(cube),0,EntityZ(cube)
		oldTime = MilliSecs() + 1500	 
	EndIf
	...
	;If EntityCollided(sphere,ENEMY_COL) Then
		;GameOver()
	;EndIf
	...
	SetFont fntArial
	Text 310,500,"Score: " + score
	Text 430,500,"Misses: " + misses
	Text 50,50,"Controls: left and right arrows to turn, You're always moving forward. Lost? Use R to reset Smilford."
	Text 50,10,"Green boxes give +10 score, but if they hit the ground even once, you lose."
